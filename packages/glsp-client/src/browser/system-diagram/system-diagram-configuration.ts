...
import { configureDefaultModelElements, configureModelElement, initializeDiagramContainer } from '@eclipse-glsp/client';
...
export class SystemDiagramConfiguration extends GLSPDiagramConfiguration {
   ...
   configureContainer(container: Container, ...containerConfiguration: ContainerConfiguration): Container {
      return initializeDiagramContainer(container, ...containerConfiguration, systemDiagramModule);
   }
}
